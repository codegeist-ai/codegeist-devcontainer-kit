...
DISPLAY=localhost:42.0 BRANCH=feature/initialize-test "$fixture_dir/.devcontainer/initialize.sh"
...
env -u BRANCH -u DISPLAY "$fixture_dir/.devcontainer/initialize.sh"
