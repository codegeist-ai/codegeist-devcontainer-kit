...
to Bitwarden-compatible servers such as Vaultwarden. The release kit does not
configure a server, log in, unlock a vault, or provide credentials. Point the
CLI at the self-hosted server before the first login:
